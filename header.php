  ...
  <div class="container-fluid navbar-border">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-anchor"></i> All Category <span class="caret"></span></a>
      ...
      <ul class="nav navbar-nav navbar-right">
	   ...
	   session_start();
          ...
          $name =$_SESSION['name'];
    echo '
    <li><a href="product/history.php"><i class="fa fa-building"></i> '.$name.' </a></li>
