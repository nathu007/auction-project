  ...
  <div class="container-fluid navbar-border">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="items.php"><i class="fa fa-building"></i> Product</a></li>
        <li><a href="history.php"><i class="fa fa-building"></i> History</a></li>
        <li class="dropdown">
     ...
     session_start();
          if(isset($_SESSION['name']  ))  {
            $name =$_SESSION['name'];
    echo '
    <li><a href="history.php"><i class="fa fa-building"></i> '.$name.' </a></li>
  <li><a href="../logout.php"><i class="fa fa-building"></i> LOGOUT</a></li> 
  ';
  }
