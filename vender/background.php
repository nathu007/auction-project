...
// if everything is ok, try to upload file
 ...
 $auction_title = $_POST['auction_title'];
   ...
   $sql="INSERT INTO `auction_item` (`id`, `start_time`, `end_time`, `description`, `category`, `item_title`, `min_bid`,`image`,`uname`) VALUES (NULL, '".$auction_start."', '".$auction_end."', '".$auction_description."', '".$auction_category."', '".$auction_title."', '".$starting_price."','".$target_file[1]."','".$sname."')";
